...
public class Examine {
    ...
    public String getExamineUserOffice() {
        return examineUserOffice;
    }

    public void setExamineUserOffice(String examineUserOffice) {
        this.examineUserOffice = examineUserOffice;
    }

    @Column(name = "examine_user_office")
    @Transient
    private String examineUserOffice;
    ...
    public String toString() {
        return "Examine{" +
                ...
                ", examineUserOffice='" + examineUserOffice + '\'' +
                '}';
    }
}