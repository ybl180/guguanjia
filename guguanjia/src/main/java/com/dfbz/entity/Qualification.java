...
public class Qualification {
    ...
    @Transient
    @Column(name = "upload_user_office_id")
    private Integer uploadUserOfficeId;
    ...
    public Integer getUploadUserOfficeId() {
        return uploadUserOfficeId;
    }

    public void setUploadUserOfficeId(Integer uploadUserOfficeId) {
        this.uploadUserOfficeId = uploadUserOfficeId;
    }
    ...
    public String toString() {
        return "Qualification{" +
                ...
                ", uploadUserOfficeId=" + uploadUserOfficeId +
                '}';
    }
}